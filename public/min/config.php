 ...
 */
require dirname(__FILE__) . '/lib/Minify/Cache/File.php';
$min_cachePath = new Minify_Cache_File(dirname(__FILE__) . '/../cache');
 ...
 */
$min_serveOptions['minApp']['noMinPattern'] = IS_DEV_ENV
	? '#\.(?:js|css)$#i'
	: '@[-\\.]min\\.(?:js|css)$@i';
